...
const deleteSelectedListBtn = document.querySelector('[data-delete-selected-list]');
...
openNav = () => {
  document.getElementById('navbar').classList.replace('navbar-closed', 'navbar-open');
...
closeNav = () => {
  document.getElementById('navbar').classList.replace('navbar-open', 'navbar-closed');
...
deleteSelectedListBtn.addEventListener('click', (e) => {
  const confirmation = confirm("If you select ok then the selected list will be deleted!");
